#
#  Be sure to run `pod spec lint SVSlidingPanel.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author             = { "Sachin Verma" => "sachin21v@gmail.com" }
  # spec.authors            = { "Sachin Verma" => "sachin21v@gmail.com" }
